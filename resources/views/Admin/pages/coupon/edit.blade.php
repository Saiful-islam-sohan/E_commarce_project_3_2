        ...
        <div class="card-body">
            <form action="{{route('coupons.update',$coupon->id)}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="coupon_name" value="{{$coupon->coupon_name}}" class="form-control @error('coupon_name')
                        is-invalid
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" name="discount_amount" value="{{$coupon->discount_amount}}" class="form-control @error('discount_amount')
                        is-invalid
                    @enderror" placeholder="enter coupon name" id="">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" value="{{$coupon->minimum_purchase_amount}}" name="minimum_purchase_amount" class="form-control @error('minimum_purchase_amount')
                        is-invalid
                    @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="validity_till" value="{{$coupon->validity_till}}" class="form-control @error('validity_till')
                        is-invalid
                    @enderror" >
                    @error('validity_till')
                        <span class="invalid-feedback" role="alert">
