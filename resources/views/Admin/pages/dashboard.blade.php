                            ...
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-title mb-2">{{$total_order_count}}</h3>
                            ...
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <span>Category</span>
                                        <h3 class="card-title text-nowrap mb-1">{{$total_categories}}</h3>
                            ...
                            <div class="col-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <span class="d-block mb-1">Total Earning</span>
                                        <h3 class="card-title text-nowrap mb-2">${{$total_earning}}</h3>
