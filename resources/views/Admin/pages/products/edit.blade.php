                   ...
                   @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" value={{$product->product_price}}  name="product_price" min="0"
                        ...
                        {{-- product off --}}
                        <div class="col-6 mb-3">
                            <label for="product_off_price" class="form-label">Product off Price</label>
                            <input type="number" value="{{$product->product_off_price}}" name="product_off_price" min="0"
                                class="form-control @error('product_off_price') is-invalid @enderror" id="product_off_price">
                            @error('product_off_price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="product_stock" value="{{$product->product_stock}}" min="1"
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" value={{$product->product_off_price}} name="alert_quantity" min="1"
                        ...
                        <!-- Product Short Description -->
                        <!-- Product long Description up -->
                        <div class="col-12 mb-3">
                            <label for="long_discription_up" class="form-label">Long Description up</label>
                            <textarea name="long_discription_up" class="form-control @error('long_discription_up') is-invalid @enderror" id="long_discription_up" id="" cols="30" rows="5"></textarea>
                            @error('long_discription_up')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        ...
                        <!-- Product long Description up -->
                        <div class="col-12 mb-3">
                            <label for="short_discription_down" class="form-label">Long Description  down</label>
                            <textarea name="short_discription_down" class="form-control @error('short_discription_down') is-invalid @enderror" id="short_discription_down" id="" cols="30" rows="5"></textarea>
                            @error('short_discription_down')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        ...
                        <div class="col-12 mb-3">
                            <label for="delivary" class="form-label">delivary</label>
                            <textarea name="delivary" class="form-control @error('delivary') is-invalid @enderror" id="delivary" id="" cols="30" rows="5"></textarea>
                            @error('delivary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-6 mb-3 mt-3 form-check form-switch">
