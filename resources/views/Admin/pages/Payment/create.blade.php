        ...
        <div class="card-body">
            <form action="{{route('payment.store')}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="payment_name" class="form-control @error('payment_name')
                        is-invalid
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" name="payment_amount" class="form-control @error('payment_amount')
                        is-invalid
