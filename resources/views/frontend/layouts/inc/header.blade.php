            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        <ul>
                            <li><i class="fi-rs-key"></i><a href="{{route('customerLogin.page')}}">Log In </a>  / <a href="{{route('registerPage')}}">Sign Up</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="header-right">
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{route('cartPage')}}">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                         ...
                                         <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media" src="{{asset('uploads/product_photos')}}/{{$item->options->product_image}}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h4><a href="product-details.html">{{$item->name}}</a></h4>
                                                <h4><span>{{$item->qty}} × </span>${{$item->qty*$item->price}}</h4>
                                            </div>
                                            <div class="shopping-cart-delete">
                                                {{-- <a href="#"><i class="fi-rs-cross-small"></i></a> --}}
                                                <a href="{{route('removeCart',['cart_id'=>$item->rowId])}}" ><i class="fi-rs-cross-small"></i></a>
                                            </div>
                                        </li>

                                         @endforeach

                                         {{-- {{asset('user')}}/assets/imgs/shop/thumbnail-3.jpg --}}
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span>{{$total_price}}</span></h4>
                                        </div>
                                        <div class="shopping-cart-button">
                                            <a href="{{route('cartPage')}}" class="outline">View cart</a>
            ...
            <div class="header-wrap header-space-between position-relative">
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{asset('user')}}/assets/imgs/banner/menu-banner-2.jpg" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{asset('user')}}/assets/imgs/banner/menu-banner-3.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{asset('user')}}/assets/imgs/banner/menu-banner-4.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="{{asset('user')}}/assets/imgs/banner/menu-banner-5.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                                ...
                                                <div class="header-banner2">
                                                    <img src="{{asset('user')}}/assets/imgs/banner/menu-banner-6.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="product-details.html"><img src="{{asset('user')}}/assets/imgs/banner/menu-banner.jpg" alt="Surfside Media"></a>
                ...
                <div class="header-action-right d-block d-lg-none">
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.php">
                                <img alt="Surfside Media" src="{{asset('user')}}/assets/imgs/theme/icons/icon-heart.svg">
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="product-details.html"><img alt="Surfside Media" src="{{asset('user')}}/assets/imgs/shop/thumbnail-3.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="product-details.html"><img alt="Surfside Media" src="{{asset('user')}}/assets/imgs/shop/thumbnail-4.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
