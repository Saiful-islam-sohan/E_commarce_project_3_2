                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10">
                                            <img src="{{asset('uploads/product_photos')}}/{{$product->product_image}}" alt="product image">
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15">
                                        ...
                                        <div>
                                            <img src="{{asset('uploads/product_photos')}}/{{$image->product_multiple_image}}" alt="product image">
                                        </div>
                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="product-detail-rating">
                                        <div class="pro-details-brand">
                                            <span> Category: <a href="shop.html">{{$product->category->title}}</a></span>
                                        </div>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            ...
                                            <span class="save-price  font-md color3 ml-15">{{$product->product_off_price}}</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('uploads/product_photos')}}/{{$rproduct->product_image}}" alt="">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <div class="product-price">
                                                    <span>${{$rproduct->product_price}} </span>
