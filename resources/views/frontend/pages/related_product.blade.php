                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Category: <a
                                                        href="shop.html">{{ $product->category->title }}</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                ...
                                                <span
                                                    class="save-price  font-md color3 ml-15">{{ $product->product_off_price }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-extralink">
                                            <form action="{{ route('addTocart') }}" method="post">
                                                ...
                                                <input type="hidden" name="product_slug" value="{{$product->slug}}">
                                                     ...
                                                     {{-- <input type="text" value="1" class="qty-val" name="order_qty"/> --}}

                                                        <input type="number" min="1" value="1" name="order_qty"  class="quantity" style="width:60px">
                                                        ...
                                                        <div class="product-img product-img-zoom">
                                                            <a href="product-details.html" tabindex="0">
                                                                <img class="default-img"
                                                                    src="{{ asset('uploads/product_photos') }}/{{ $rproduct->product_image }}"
                                                                    alt="">
