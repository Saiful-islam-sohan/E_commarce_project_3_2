                        ...
                        <div class="col-md-4">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="track-orders-tab" data-bs-toggle="tab" href="#track-orders" role="tab" aria-controls="track-orders" aria-selected="false"><i class="fi-rs-shopping-cart-check mr-10"></i>Payment Confirm</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-pane fade" id="track-orders" role="tabpanel" aria-labelledby="track-orders-tab">
                                    <div class="card">
                                        ...
                                        <div class="card-body contact-from-area">
                                            <p>To Payment your order please enter your OrderID in the box below and press "Confirm" button. This was given to you on your receipt and in the confirmation email you should have received.</p>
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <form action="{{route('ApplyPament')}}" method="post">
                                                        @csrf
                                                        <input type="text" name="payment_name" placeholder="Payment Code" class="form-control">
                                                        <button type="submit" class="submit submit-auto-width">Confirm</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
